...
_G.packer_plugins = {
  ...
  ["printer.nvim"] = {
    ...
    loaded = true,
    path = "/home/hatredholder/.local/share/nvim/site/pack/packer/start/printer.nvim",
  ...
  ["telescope-undo.nvim"] = {
    loaded = true,
    path = "/home/hatredholder/.local/share/nvim/site/pack/packer/start/telescope-undo.nvim",
